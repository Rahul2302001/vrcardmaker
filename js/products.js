    ...
    product => ` 
                  <div class="product category__products">
                    ...
                    <div class="product__footer">
                      ...
                      <a href="tel:8968888188"><button type="submit" class="product__btn">Call Now</button></a>
                    </div>
                  <ul>
                      <li>
                        <a data-tip="Quick View" data-place="left" href="${product.image}">
                          <svg>
                      ...
                      <li>
                        <a data-tip="Add To Wishlist" data-place="left" href="${product.image}">
                          <svg>
                      ...
                      <li>
                        <a data-tip="Add To Compare" data-place="left" href="${product.image}">
                          <svg>
...
["mouseover", "touchstart"].forEach(event => {
  if (picContainer) {
    picContainer.addEventListener(event, e => {
      ...
      changeImage(`./images/products${id}.jpg`, id);
    });
  }
});
